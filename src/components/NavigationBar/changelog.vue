    ...
    methods: {
        changelog() {
            Swal.fire({
                ...
                html:`
                <h3><b>New Block!</b></h2>
                <img src='https://media.discordapp.net/attachments/935597297528610856/991985618554994708/unknown.png' width='475'>
                <h5>(Freslin)</h5>
                <br> 
                <h3><b>New Block!</b></h2>
                <img src='https://cdn.discordapp.com/attachments/935597297528610856/991739773616148590/unknown.png'>
                <h5>(Freslin)</h5>
                <br> 
